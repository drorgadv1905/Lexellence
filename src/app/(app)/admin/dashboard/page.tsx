...
import { Calendar, Users, UserPlus, Share2, MessageSquare, Plus, Bell, ClipboardList } from "lucide-react";
    ...
    <div>
      <div className="hero-banner mb-8">
        <div className="relative z-10">
          <p className="text-gold-400 text-sm font-medium mb-1">ניהול קבוצה</p>
          <h1 className="font-display text-3xl font-semibold">דשבורד מנהל קבוצה</h1>
        </div>
      </div>
      ...
      <h3 className="font-display font-semibold text-forest-900 mb-4">פעולות מהירות</h3>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <Link href="/admin/events" className="quick-link text-center py-5">
          <Plus className="w-6 h-6 mx-auto text-gold-500 mb-2" />
          <span className="text-sm font-medium text-forest-800">הוסף אירוע</span>
        </Link>
        <Link href="/admin/announcements" className="quick-link text-center py-5">
          <Bell className="w-6 h-6 mx-auto text-gold-500 mb-2" />
          <span className="text-sm font-medium text-forest-800">שלח הודעה</span>
        </Link>
        <Link href="/admin/candidates" className="quick-link text-center py-5">
          <Users className="w-6 h-6 mx-auto text-gold-500 mb-2" />
          <span className="text-sm font-medium text-forest-800">אשר מועמדים</span>
        </Link>
        <Link href="/admin/summaries" className="quick-link text-center py-5">
          <ClipboardList className="w-6 h-6 mx-auto text-gold-500 mb-2" />
